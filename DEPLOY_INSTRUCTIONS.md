...
### 3. Настроить Build Command в Render

В настройках веб-сервиса на Render установите Build Command:

```bash
npm install && npm run setup:production && npm run build
```

Это обеспечит:
1. Установку всех зависимостей
2. Автоматическую настройку БД (миграции + создание пользователя)
3. Сборку Next.js приложения
